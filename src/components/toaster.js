...
export default function Toaster({show, children, color, close}) {
    ...
    return(
        show ? <div style={{position: 'fixed', left: '15vw', top: '2rem', right:'15vw', filter:'drop-shadow(0.5em 1em -0.125em rgba(10,10,10,0.02)'}}><div className={`notification is-${color} mb-0`}>
