...
![lookback-clock](lookback.assets/lookback-clock.jpg) The first personal project I made after finishing the tutorials.
...
![lookback-speaker](lookback.assets/lookback-speaker.jpg) A hacked together bluetooth speaker I designed and printed an enclosure for.
...
![lookback-antenna](lookback.assets/lookback-antenna.jpg) Spider antenna built during engineering project I.
...
![lookback-hackathon](lookback.assets/lookback-hackathon.jpg) A panorama from the WhatTheHack event organized by AFT and Tobania in 2019.
...
![lookback-seeds](lookback.assets/lookback-seeds.jpg) Group picture with the seeds elects from Belgium, Luxembourg and the Netherlands at the Huawei exhibition center.
...
![lookback-lanparty](lookback.assets/lookback-lanparty.jpg) A picture taken at the 2019 edition of TermiLAN, the yearly VTK LAN party.
...
![lookback-covid](lookback.assets/lookback-covid.jpg) Me during the first online-taught class, at the beginning of the lockdown in March 2020.
